...
const Page = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white p-4 md:p-6 flex flex-col lg:flex-col gap-6">
        ...
        >
          <div className="p-6">
            ...
            <div className="flex flex-col items-center justify-center gap-4 p-6 mb-6 bg-gray-50 rounded-lg">
              <div className="h-20 w-20 rounded-full border-2 border-orange-500/20 bg-gray-200 text-gray-600 text-2xl flex items-center justify-center font-medium">
